...
function draw(){
  ...
  noFill()
  rect(xDelta, height/2, abs(100 * sin(x)),abs(100 * sin(x)))
  stroke(255,0,0,abs(255 * sin(x)))
  // stroke(0,68,170)
  noFill()
  rect(width - xDelta, height/2, abs(100 * sin(x)),abs(100 * sin(x)))
  // rect(width - (xDelta + (10 * sin(x))), height/2, abs(100 * sin(x)),abs(100 * sin(x)))


  stroke(0,68,170,abs(255 * sin(x)))
  noFill()
  rect(width/2, height - xDelta, abs(100 * sin(x)),abs(100 * sin(x)))
  // rect(width/2, height - (xDelta + (10 * sin(x))), abs(100 * sin(x)),abs(100 * sin(x)))

  stroke(0,0,255,abs(255 * sin(x)))
  noFill()
  rect(width/2, xDelta, abs(100 * sin(x)),abs(100 * sin(x)))
